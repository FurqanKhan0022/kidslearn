...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.22.0/sweetalert2.min.js" integrity="sha512-Mk6B5RocyakMGk482PINrppWkkovfxH8EQllZ8Q4I8LY6nfXVy5yeP6Hp7YsRuzERD0aYSbpdSTPDDvOSOJrxA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <!-- Favicon -->
...
<body>
    <div class="container-xxl bg-white p-0">
      ...
      <!-- Navbar Start -->        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
